...
Gui, Add, Checkbox, vCheckbox3, Energy Drink
...
ShowValue:
     ...
     TrayTip,, Food for slot 2-4`nWater for slot 5-7
...
Start:
     ...
     Loop
     {
          ...
          If (Checkbox2 = 1)
          {
               ImageSearch, FoundX, FoundY, 367, 454, 450, 487, *70, %A_ScriptDir%\bin\pt.bmp
               If errorlevel = 1
               {
          ...
          Loop
          {
               ...
               if ErrorLevel = 0
               {
                    ImageSearch, FoundX, FoundY, 367, 340, 450, 363, *50, %A_ScriptDir%\bin\Start.bmp
                    If errorlevel = 0
                    {
                         Click, 512, 316
                         sleep 500
               ...
               If (A_TickCount - LoopStartTimeOuter >= 80000)
                    Break
          }
     }
Return
